...
const EditTestModal = ({ isOpen, onClose, onEdit, test, validationErrors = {} }) => {
          ...
          <div className="mb-4 ">
            ...
            <div className="grid  md:grid-cols-3 xl:grid-cols-4    gap-2 mb-2">
              <input
                ...
                className={` outline-none col-span-1 px-3 py-2 border rounded-lg ${
                  validationErrors['parameters.*.parameter_name'] ? 'border-red-500' : ''
                }`}
              />
              <input
                type="text"
                ...
                className={` outline-none col-span-1 px-3 py-2 border rounded-lg ${
                  validationErrors['parameters.*.unit'] ? 'border-red-500' : ''
                }`}
              />
              <input
                type="text"
                ...
                className={` outline-none col-span-1 px-3 py-2 border rounded-lg ${
                  validationErrors['parameters.*.normal_range'] ? 'border-red-500' : ''
                }`}
              />
              <button
                type="button"
            ...
            <div className="space-y-2">
              {parameters.map((param, index) => (
                <div key={param.id || index} className="flex items-center justify-between bg-gray-50 p-2 rounded-lg">
